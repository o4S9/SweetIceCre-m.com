...
void main() {
  testWidgets('Slider uses BarSliderThumbShape, ExpressiveRoundedRectSliderTrackShape, and RoundedRectSliderValueIndicatorShape',
    (WidgetTester tester) async {
      ...
      expect(theme.sliderTheme.thumbShape, isA<BarSliderThumbShape>());
      expect(theme.sliderTheme.trackShape, isA<ExpressiveRoundedRectSliderTrackShape>());
      expect(theme.sliderTheme.valueIndicatorShape, isA<RoundedRectSliderValueIndicatorShape>());
  });
