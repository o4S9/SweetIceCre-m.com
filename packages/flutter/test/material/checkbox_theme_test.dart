...
void main() {
  ...
  testWidgets('Checkbox is themeable (WidgetStateProperty.map)', (WidgetTester tester) async {
    tester.binding.focusManager.highlightStrategy = FocusHighlightStrategy.alwaysTraditional;
  ...
  testWidgets('Checkbox theme overlay color resolves in active/pressed states (WidgetStateProperty.map)', (WidgetTester tester) async {
    const Color activePressedOverlayColor = Color(0xFF000001);
    const Color inactivePressedOverlayColor = Color(0xFF000002);
