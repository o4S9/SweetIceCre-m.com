...
void main() {
  ...
  testWidgets('Material3 - SwitchListTile respects WidgetStateMap color in active/enabled states', (WidgetTester tester) async {
    const Color activeEnabledThumbColor = Color(0xFF000001);
    const Color activeDisabledThumbColor = Color(0xFF000002);
    const Color inactiveEnabledThumbColor = Color(0xFF000003);
    const Color inactiveDisabledThumbColor = Color(0xFF000004);
    ...
    final WidgetStateProperty<Color> thumbColor = WidgetStateColor.map(<WidgetStateMapKey, Color>{
      ...
      WidgetState.any:      inactiveEnabledThumbColor,
    });
  ...
  testWidgets('The overlay color for the thumb of the switch resolves in WidgetStateMap active/pressed/hovered states', (WidgetTester tester) async {
    tester.binding.focusManager.highlightStrategy = FocusHighlightStrategy.alwaysTraditional;
    const Color activeThumbColor = Color(0xFF000000);
    const Color inactiveThumbColor = Color(0xFF000010);
    const Color activePressedOverlayColor = Color(0xFF000001);
      ...
      return MaterialApp(
        home: Scaffold(
          body: SwitchListTile(
            ...
            overlayColor: useOverlay ? WidgetStateProperty.map(overlayMap) : null,
            hoverColor: hoverColor,
          ),
        ),
      );
