...
void main() {
  ...
  testWidgets('ExpressiveRoundedRectSliderTrackShape default size and color', (WidgetTester tester) async {
    final ThemeData theme = ThemeData(
      sliderTheme: const SliderThemeData(
  ...
  testWidgets('Material2 - ExpressiveRoundedRectSliderTrackShape default size and color', (WidgetTester tester) async {
    final ThemeData theme = ThemeData(
      sliderTheme: const SliderThemeData(
        trackShape: ExpressiveRoundedRectSliderTrackShape(),
      ),
  ...
  testWidgets('ExpressiveRoundedRectSliderTrackShape draws a stop indicator', (WidgetTester tester) async {
    final ThemeData theme = ThemeData(
      sliderTheme: const SliderThemeData(
        trackShape: ExpressiveRoundedRectSliderTrackShape(),
      ),
  ...
  testWidgets('Can override ExpressiveRoundedRectSliderTrackShape track height', (WidgetTester tester) async {
    const double trackHeight = 4.0;
    await tester.pumpWidget(
      MaterialApp(
        theme: ThemeData(
  ...
  testWidgets('Can override ExpressiveRoundedRectSliderTrackShape track gap', (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        theme: ThemeData(
          sliderTheme: const SliderThemeData(
  ...
  testWidgets('ExpressiveRoundedRectSliderTrackShape track gap shrinks when pressed', (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        theme: ThemeData(
          sliderTheme: const SliderThemeData(
