...
class SliderThemeData with Diagnosticable {
  ...
  ///
  /// If provided, this value will be used for the track height of the [Slider].
  ///
  /// If [SliderThemeData.trackShape] is [ExpressiveRoundedRectSliderTrackShape], the track
  /// height uses 16 pixels. Otherwise, the default track height is 4 pixels.
  ...
  final Size? barThumbSize;

  /// The size of the gap between the active and inactive track of [ExpressiveRoundedRectSliderTrackShape].
  ///
  /// If [SliderThemeData.trackShape] is [ExpressiveRoundedRectSliderTrackShape], this
  /// property is used to set the gap between the active and inactive track. Otherwise,
  ...
  static SliderThemeData lerp(SliderThemeData a, SliderThemeData b, double t) {
    ...
    return SliderThemeData(
      ...
      barThumbSize: Size.lerp(a.barThumbSize, b.barThumbSize, t),
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<Size>('barThumbSize', barThumbSize, defaultValue: defaultData.barThumbSize));
...
class BarSliderThumbShape extends SliderComponentShape {
  ...
  void paint(
    ...
    final Canvas canvas = context.canvas;
    final Size thumbSize = sliderTheme.barThumbSize!;
...
/// The expressive rounded rectangular shape of a [Slider]'s thumb.
///
/// The [ExpressiveRoundedRectSliderTrackShape] consist of active and inactive
...
/// width is reduced as a result the track gap size in [ExpressiveRoundedRectSliderTrackShape]
/// is also reduced.
///
...
class ExpressiveRoundedRectSliderTrackShape extends SliderTrackShape with BaseSliderTrackShape {
  /// Create a slider track that draws two rectangles with rounded outer edges.
  const ExpressiveRoundedRectSliderTrackShape();
  ...
  void paint(
    ...
    final Radius activeTrackCornerRadius = Radius.circular(trackRect.shortestSide / 2);
    const Radius trackInsideCornerRadius = Radius.circular(2.0);

    final Radius topLeftRadius = (textDirection == TextDirection.ltr)
      ? trackCornerRadius
      : activeTrackCornerRadius;
    final Radius bottomLeftRadius = (textDirection == TextDirection.ltr)
      ? activeTrackCornerRadius
      : trackCornerRadius;
    final Radius topRightRadius = (textDirection == TextDirection.rtl)
      ? activeTrackCornerRadius
      : trackCornerRadius;
    final Radius bottomRightRadius = (textDirection == TextDirection.rtl)
      ? activeTrackCornerRadius
      : trackCornerRadius;
    ...
    const double stopIndicatorTrailingSpace = 6.0 + 2.0;
