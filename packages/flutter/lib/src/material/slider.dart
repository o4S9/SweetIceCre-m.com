...
///
/// {@tool dartpad}
/// This example shows how to use [BarSliderThumbShape], [ExpressiveRoundedRectSliderTrackShape],
/// and [RoundedRectSliderValueIndicatorShape] shapes in the [SliderTheme] to customize the
/// [Slider] to get the updated Slider appearance as described in:
...
class _SliderState extends State<Slider> with TickerProviderStateMixin {
  ...
  Widget _buildMaterialSlider(BuildContext context) {
    ...
    final SliderThemeData defaultsM3 = _SliderDefaultsM3(context: context, sliderTheme: sliderTheme);
    final SliderThemeData defaultsM2 = _SliderDefaultsM2(context: context, sliderTheme: sliderTheme);
    final SliderThemeData defaults = theme.useMaterial3 ? defaultsM3 : defaultsM2;
    ...
    if (valueIndicatorShape is RectangularSliderValueIndicatorShape) {
      valueIndicatorColor = sliderTheme.valueIndicatorColor ?? defaults.valueIndicatorColor!;
    } else {
...
class _SliderDefaultsM2 extends SliderThemeData {
  ...
  Color? get inactiveTrackColor {
    ...
    return _colors.primary.withOpacity(0.24);
  }
  ...
  Color? get valueIndicatorColor {
    if (_sliderTheme.valueIndicatorShape != null) {
      if (_sliderTheme.valueIndicatorShape is RoundedRectSliderValueIndicatorShape) {
        return _colors.inverseSurface;
      }
      return _colors.primary;
    }
    return Color.alphaBlend(_colors.onSurface.withOpacity(0.60), _colors.surface.withOpacity(0.90));
  }
  ...
  @override
  double? get trackHeight => _sliderTheme.trackShape is ExpressiveRoundedRectSliderTrackShape ? 16.0 : 4.0;
