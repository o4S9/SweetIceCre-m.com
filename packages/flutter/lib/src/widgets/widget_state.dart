...
abstract class WidgetStateMatch with _WidgetStateOperators {
  /// Abstract const constructor. This constructor enables subclasses to provide
  /// const constructors so that they can be used in const expressions.
  const WidgetStateMatch();
...
/// instead `implements` the [WidgetStateMatch] class using this mixin.
///
/// {@macro flutter.widgets.WidgetStateProperty.WidgetStateMap}
...
class _AlwaysMatch extends WidgetStateMatch {
  const _AlwaysMatch();
...
/// {@endtemplate}
enum WidgetState with _WidgetStateOperators implements WidgetStateMatch {
...
abstract class WidgetStateColor extends Color implements WidgetStateProperty<Color> {
  ...
  /// state.
  factory WidgetStateColor.resolveWith(WidgetPropertyResolver<Color> callback) = _WidgetStateColorWith;
...
class _WidgetStateColorWith extends WidgetStateColor {
  _WidgetStateColorWith(this._resolve) : super(_resolve(_defaultStates).value);
...
abstract class WidgetStateBorderSide extends BorderSide implements WidgetStateProperty<BorderSide?> {
  ...
  /// ),
  /// ```
  const factory WidgetStateBorderSide.resolveWith(WidgetPropertyResolver<BorderSide?> callback) = _WidgetStateBorderSideWith;
...
class _WidgetStateBorderSideWith extends WidgetStateBorderSide {
  const _WidgetStateBorderSideWith(this._resolve);
...
abstract class WidgetStateTextStyle extends TextStyle implements WidgetStateProperty<TextStyle> {
  ...
  /// state.
  const factory WidgetStateTextStyle.resolveWith(WidgetPropertyResolver<TextStyle> callback) = _WidgetStateTextStyleWith;
...
class _WidgetStateTextStyleWith extends WidgetStateTextStyle {
  const _WidgetStateTextStyleWith(this._resolve);
...
abstract class WidgetStateProperty<T> {
  ...
  const factory WidgetStateProperty.resolveWith(WidgetPropertyResolver<T> callback) = _WidgetStatePropertyWith<T>;
...
/// the current set of Material states.
///
...
/// ```
///
/// A Material state combination can be stored in a variable,
